...
namespace Minecraft.Crafting.Api.Controllers
{
    ...
    public class CraftingController : ControllerBase
    {
        ...
        {
            var data = JsonSerializer.Deserialize<List<Item>>(System.IO.File.ReadAllText("../MyPotion/wwwroot/data.json"), _jsonSerializerOptions);
            ...
            System.IO.File.WriteAllText("../MyPotion/wwwroot/data.json", JsonSerializer.Serialize(data, _jsonSerializerOptions));
        ...
        public Task Update(int id, Item item)
        {
            ...
            itemOriginal.Image = item.Image;
            itemOriginal.Effect = item.Effect;
            itemOriginal.Special = item.Special;
